...
export default function ModalCliente({ open, onClose, onSave, onCancel, editedEmployee, selectedDate, handleDateChange, editedFields, setEditedFields, errors }) {
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={4}>
                            <TextField
                                select
                                label="Estado"
                                value={editedFields.estado_cliente || ''}
                                onChange={(e) => {
                                    setEditedFields({ ...editedFields, estado_cliente: e.target.value });
                                }}
                                fullWidth
                            >
